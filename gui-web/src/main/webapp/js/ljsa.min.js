...
s>=0&&setTimeout(function(){e.tabResult.select([s])},100),e.selId=null}})},s}(WUX.WComponent)
...
return s.name="LJSASelClassi",s}return __extends(e,t),e.prototype.componentDidMount=function(){var t={ajax:{dataType:"json",delay:400,processResults:function(t,e){return{results:t}},transport:function(t,e,i){jrpc.execute("CLASSI.lookup",[t.data.q],e)}},placeholder:"",allowClear:!0,minimumInputLength:3}
...
"D"==s?WUX.setCss(i.rowElement,WUX.CSS.ERROR):"E"==s&&WUX.setCss(i.rowElement,WUX.CSS.SUCCESS)}}),this.tabCon=new WUX.WDXTable(this.subId("tbc"),["Opzione","Descrizione","Valore"],[t.ISched.sCONF_OPZIONE,t.ISched.sCONF_DESCRIZIONE,t.ISched.sCONF_VALORE]),this.tabCon.selectionMode="single",this.tabCon.css({h:240}),this.tabCon.onDoubleClick(function(t){var e=i.tabCon.getSelectedRowsData()
e&&e.length&&(i.dlgCon.setState(e[0]),i.dlgCon.show(i))}),this.btnAddCon=new WUX.WButton(this.subId("bac"),t.TXT.ADD,"",WUX.BTN.SM_PRIMARY),this.btnAddCon.on("click",function(t){i.dlgCon.setState(null),i.dlgCon.show(i)}),this.btnRemCon=new WUX.WButton(this.subId("brc"),t.TXT.REMOVE,"",WUX.BTN.SM_DANGER),this.btnRemCon.on("click",function(t){var e=i.tabCon.getSelectedRows()
if(e&&e.length){var s=i.tabCon.getState()
