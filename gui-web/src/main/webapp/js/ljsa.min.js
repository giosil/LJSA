...
d?(s[n][t.ISched.sSTATO]="A",i.btnToggle.setText("Disabilita",WUX.WIcon.THUMBS_O_DOWN)):(s[n][t.ISched.sSTATO]="D",i.btnToggle.setText("Abilita",WUX.WIcon.THUMBS_O_UP)),i.tabResult.refresh(),setTimeout(function(){i.tabResult.select([n])},100)}else i.find()})}),this.btnLog=new WUX.WButton(this.subId("bl"),t.TXT.VIEW,t.ICO.VIEW,WUX.BTN.ACT_OUTLINE_INFO),this.btnLog.on("click",function(a){i.btnLog.blur()
var s=i.tabResult.getSelectedRowsData()
