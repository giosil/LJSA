var GUI
!function(t){var e=WUX.WUtil,i=function(i){function s(s){var a=i.call(this,s||"*","GUIAttivita")||this
return a.iSTATUS_STARTUP=0,a.iSTATUS_VIEW=1,a.iSTATUS_EDITING=2,a.status=a.iSTATUS_STARTUP,a.dlgCon=new t.DlgAttCon(a.subId("dlgac")),a.dlgCon.onHiddenModal(function(i){if(a.dlgCon.ok){var s=a.tabCon.getState(),n=a.dlgCon.getState(),o=e.indexOf(s,t.IAtt.sCONF_OPZIONE,n[t.IAtt.sCONF_OPZIONE])
o>=0?s[o]=n:s.push(n),a.tabCon.setState(s)}}),a.dlgPar=new t.DlgAttPar(a.subId("dlgap")),a.dlgPar.onHiddenModal(function(i){if(a.dlgPar.ok){var s=a.tabPar.getState(),n=a.dlgPar.getState(),o=e.indexOf(s,t.IAtt.sPAR_PARAMETRO,n[t.IAtt.sPAR_PARAMETRO])
o>=0?s[o]=n:s.push(n),a.tabPar.setState(s)}}),a.dlgNot=new t.DlgAttNot(a.subId("dlgan")),a.dlgNot.onHiddenModal(function(e){if(a.dlgNot.ok){var i=a.tabNot.getState(),s=a.dlgNot.getState(),n=t.indexOf(i,t.IAtt.sNOT_EVENTO,t.IAtt.sNOT_DESTINAZIONE,s[t.IAtt.sCONF_OPZIONE]+":"+s[t.IAtt.sNOT_DESTINAZIONE])
n>=0?i[n]=s:i.push(s),a.tabNot.setState(i)}}),a}return __extends(s,i),s.prototype.render=function(){var i=this
...
s instanceof WUX.WBox&&(i.tagsFilter.setState(i.fpFilter.getValues(!0)),s.collapse()),i.selId=null,i.find()}),this.btnReset=new WUX.WButton(this.subId("br"),t.TXT.RESET,"",WUX.BTN.SM_SECONDARY),this.btnReset.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
i.fpFilter.clear(),i.tagsFilter.setState({}),i.tabResult.setState([]),i.clearDet(),i.status=i.iSTATUS_STARTUP}),this.fpFilter=new WUX.WFormPanel(this.subId("ff")),this.fpFilter.addRow(),this.fpFilter.addComponent(t.IAtt.sID_SERVIZIO,"Servizio",new t.LJSASelServizi),this.fpFilter.addTextField(t.IAtt.sID_ATTIVITA,"Codice"),this.fpFilter.addTextField(t.IAtt.sDESCRIZIONE,"Descrizione"),this.selSerDet=new t.LJSASelServizi,this.fpDetail=new WUX.WFormPanel(this.subId("fpd")),this.fpDetail.addRow(),this.fpDetail.addComponent(t.IAtt.sID_SERVIZIO,"Servizio",this.selSerDet),this.fpDetail.addTextField(t.IAtt.sID_ATTIVITA,"Codice"),this.fpDetail.addRow(),this.fpDetail.addComponent(t.IAtt.sCLASSE,"Classe",new t.LJSASelClassi),this.fpDetail.addTextField(t.IAtt.sDESCRIZIONE,"Descrizione"),this.fpDetail.addInternalField(t.IAtt.sID_CREDENZIALE_INS),this.fpDetail.addInternalField(t.IAtt.sDATA_INS),this.fpDetail.addInternalField(t.IAtt.sORA_INS),this.fpDetail.enabled=!1,this.fpFilter.onEnterPressed(function(t){i.btnFind.trigger("click")}),this.btnNew=new WUX.WButton(this.subId("bn"),t.TXT.NEW,"",WUX.BTN.SM_INFO),this.btnNew.on("click",function(e){if(i.status==i.iSTATUS_EDITING)return void i.btnNew.blur()
i.isNew=!0,i.status=i.iSTATUS_EDITING,i.selId=null,i.tabResult.clearSelection(),i.enableDet(!0),i.clearDet(),i.setDefCon(),i.selSerDet.setState(t._defService),setTimeout(function(){i.fpDetail.focus()},100)}),this.btnOpen=new WUX.WButton(this.subId("bo"),t.TXT.OPEN,t.ICO.OPEN,WUX.BTN.ACT_OUTLINE_PRIMARY),this.btnOpen.on("click",function(t){if(i.status==i.iSTATUS_EDITING||i.status==i.iSTATUS_STARTUP)return void i.btnOpen.blur()
...
a[t.IAtt.sCONFIGURAZIONE]=i.tabCon.getState(),a[t.IAtt.sPARAMETRI]=i.tabPar.getState(),a[t.IAtt.sNOTIFICA]=i.tabNot.getState(),t.putUserLog(a),i.isNew?jrpc.execute("ATTIVITA.insert",[a],function(e){i.status=i.iSTATUS_VIEW,i.enableDet(!1),i.selId=e[t.IAtt.sID_SERVIZIO]+":"+e[t.IAtt.sID_ATTIVITA],i.find()}):jrpc.execute("ATTIVITA.update",[a],function(e){i.status=i.iSTATUS_VIEW,i.enableDet(!1),i.selId=e[t.IAtt.sID_SERVIZIO]+":"+e[t.IAtt.sID_ATTIVITA]
var s=i.tabResult.getSelectedRows()
if(s&&s.length){var a=s[0]
i.tabResult.getState()[a]=e,i.tabResult.refresh(),setTimeout(function(){i.tabResult.select([a])},100)}else i.find()})}),this.btnCancel=new WUX.WButton(this.subId("bc"),t.TXT.CANCEL,t.ICO.CANCEL,WUX.BTN.ACT_OUTLINE_INFO),this.btnCancel.on("click",function(e){if(i.status!=i.iSTATUS_EDITING)return void i.btnCancel.blur()
...
if(a&&a.length){var n=e.getString(a[0],t.IAtt.sID_SERVIZIO),o=e.getString(a[0],t.IAtt.sID_ATTIVITA)
...
if(e&&e.length){var s=i.tabPar.getState()
s.splice(e[0],1),i.tabPar.setState(s)}}),this.tabNot=new WUX.WDXTable(this.subId("tbn"),["Evento","Destinazione"],[t.IAtt.sNOT_EVENTO,t.IAtt.sNOT_DESTINAZIONE]),this.tabNot.selectionMode="single",this.tabNot.css({h:240}),this.tabNot.onDoubleClick(function(t){var e=i.tabPar.getSelectedRowsData()
...
if(s){var a=e.getString(s,t.IAtt.sID_SERVIZIO),n=e.getString(s,t.IAtt.sID_ATTIVITA)
a&&n&&(this.clearDet(),this.status==this.iSTATUS_EDITING&&(WUX.showWarning("Modifiche annullate"),this.enableDet(!1)),jrpc.execute("ATTIVITA.read",[a,n],function(s){s[t.IAtt.sID_SERVIZIO]=t.getIdVal(s,t.IAtt.sID_SERVIZIO),i.fpDetail.setState(s),i.tabCon.setState(e.getArray(s,t.IAtt.sCONFIGURAZIONE)),i.tabPar.setState(e.getArray(s,t.IAtt.sPARAMETRI)),i.tabNot.setState(e.getArray(s,t.IAtt.sNOTIFICA)),i.status=i.iSTATUS_VIEW}))}},s.prototype.clearDet=function(){this.fpDetail.clear(),this.tabCon.setState([]),this.tabPar.setState([]),this.tabNot.setState([])},s.prototype.enableDet=function(t){this.fpDetail.enabled=t,this.tabCon.enabled=t,this.tabPar.enabled=t,this.tabNot.enabled=t},s.prototype.find=function(){var e=this,i=t.getUserLogged()
jrpc.execute("ATTIVITA.find",[this.fpFilter.getState(),i.groups],function(i){if(e.tabResult.setState(i),e.clearDet(),e.status=e.iSTATUS_STARTUP,e.selId){var s=t.indexOf(i,t.IAtt.sID_SERVIZIO,t.IAtt.sID_ATTIVITA,e.selId)
s>=0&&setTimeout(function(){e.tabResult.select([s])},100),e.selId=null}})},s.prototype.setDefCon=function(){for(var e=[["nolog","Se S le elaborazioni NON vengono tracciate in archivio","S, N","N"],["attachFiles","Se S i file prodotti vengono inviati in allegato alla mail","S, N","N"],["attachErrorFiles","Se S i file di errore prodotti vengono inviati in allegato alla mail","S, N","N"],["compressFiles","Se S i file prodotti vengono compressi","S, N","N"],["excludeHolidays","Se S vengono esclusi i giorni festivi","S, N","N"],["single","Se S si bloccano esecuzioni sovrapposte dello stesso job","S, N","N"],["fileInfo","Se S viene creato il file di informazioni predefinito","S, N","N"],["timeout","Timeout di elaborazione espresso in minuti","","0"]],i=[],s=0;s<e.length;s++){var a={}
a[t.IAtt.sCONF_OPZIONE]=e[s][0],a[t.IAtt.sCONF_DESCRIZIONE]=e[s][1],a[t.IAtt.sCONF_VALORI]=e[s][2],a[t.IAtt.sCONF_PREDEFINITO]=e[s][3],i.push(a)}this.tabCon.setState(i)},s}(WUX.WComponent)
...
return!t||"object"!=typeof t}function n(t,e,i,s){if(!t||!e||!i)return-1
for(var a=d.toArray(t),n=0;n<a.length;n++){if(d.getValue(a[n],e)+":"+d.getValue(a[n],i)==s)return n}return-1}function o(t){return t?(t[r.sUSER_LOG]=e().userName,t):t}function l(t,e){if(!t||!e)return t
var i=t[e]
return Array.isArray(i)?i.length>1?i[0]:null:i}var d=WUX.WUtil
t.LJSA_SERVICE="LJSA",t._defService="",t.getUserLogged=e,t.getConfig=i,t.getLocale=s,t.isDevMode=a,t.indexOf=n,t.putUserLog=o,t.getIdVal=l
...
n instanceof WUX.WBox&&(i.tagsFilter.setState(i.fpFilter.getValues(!0)),n.collapse()),jrpc.execute("CLASSI.find",[i.fpFilter.getState()],function(s){if(i.tabResult.setState(s),i.fpDetail.clear(),i.status=i.iSTATUS_STARTUP,i.selId){var a=e.indexOf(s,t.IClasse.sCLASSE,i.selId)
...
if(s)return i.btnSave.blur(),void WUX.showWarning("Specificare: "+s)
var a=i.fpDetail.getState()
i.isNew?jrpc.execute("CLASSI.insert",[a],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.IClasse.sCLASSE],i.btnFind.trigger("click")}):jrpc.execute("CLASSI.update",[a],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.IClasse.sCLASSE]
var s=i.tabResult.getSelectedRows()
if(s&&s.length){var a=s[0]
...
var a=i.tabResult.getSelectedRowsData()
if(a&&a.length){var n=e.getString(a[0],t.IClasse.sCLASSE)
...
if(s){var a=e.getString(s,t.IClasse.sCLASSE)
a&&(this.fpDetail.clear(),this.status==this.iSTATUS_EDITING&&(WUX.showWarning("Modifiche annullate"),this.fpDetail.enabled=!1),jrpc.execute("CLASSI.read",[a],function(t){i.fpDetail.setState(t),i.status=i.iSTATUS_VIEW}))}},s}(WUX.WComponent)
...
var a=e.toString(s)
a&&(t._defService=a)},s.prototype.componentDidMount=function(){var e=this,i=t.getUserLogged()
jrpc.execute("SERVIZI.lookup",[i.groups],function(t){for(var i=[],s=0;s<t.length;s++){var a=t[s],n={id:a[0],text:a[0]}
i.push(n)}var o={data:i,placeholder:"",allowClear:!0}
e.init(o)})},s}(WUX.WSelect2)
t.LJSASelServizi=s
var a=function(t){function e(e,i){var s=t.call(this,e,[],i)||this
return s.name="LJSASelClassi",s}return __extends(e,t),e.prototype.updateState=function(e){e&&(Array.isArray(e)||(e=[e,e])),t.prototype.updateState.call(this,e)},e.prototype.componentDidMount=function(){var t={ajax:{dataType:"json",delay:400,processResults:function(t,e){var i=[]
if(t)for(var s=0;s<t.length;s++)i.push({id:t[s][0],text:t[s][2]})
...
t.LJSASelClassi=a
var n=function(i){function s(t,e){var s=i.call(this,t)||this
return s.multiple=e,s.name="LJSASelAttivita",s}return __extends(s,i),Object.defineProperty(s.prototype,"service",{set:function(e){this._serviceS=e,e&&e!=this._serviceL&&(t._defService=e,this.reload(!1))},enumerable:!1,configurable:!0}),s.prototype.updateState=function(s){i.prototype.updateState.call(this,s)
var a=e.toString(s)
a&&(t._defService=a)},s.prototype.componentDidMount=function(){var e=this
jrpc.execute("ATTIVITA.lookup",[t._defService,""],function(i){e._serviceL=t._defService
for(var s=[],a=0;a<i.length;a++){var n=i[a],o={id:n[0],text:n[0]}
s.push(o)}var l={data:s,placeholder:"",allowClear:!0}
...
return s.multiple=i,s.name="LJSASelEventi",s.options=[{id:"",text:""},{id:"R",text:"(R) Risultato elaborazione"},{id:"E",text:"(E) Eccezione verificatasi"},{id:"T",text:"(T) Timeout raggiunto"}],s}return __extends(e,t),e}(WUX.WSelect2)
...
jrpc.execute("CREDENZIALI.find",[i.fpFilter.getState(),n.groups],function(e){if(i.tabResult.setState(e),i.fpDetail.clear(),i.status=i.iSTATUS_STARTUP,i.selId){var s=t.indexOf(e,t.ICredenziale.sID_SERVIZIO,t.ICredenziale.sID_CREDENZIALE,i.selId)
...
if(s)return i.btnSave.blur(),void WUX.showWarning("Specificare: "+s)
var a=i.fpDetail.getState()
i.isNew?jrpc.execute("CREDENZIALI.insert",[a],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.ICredenziale.sID_SERVIZIO]+":"+e[t.ICredenziale.sID_CREDENZIALE],i.btnFind.trigger("click")}):jrpc.execute("CREDENZIALI.update",[a],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.ICredenziale.sID_SERVIZIO]+":"+e[t.ICredenziale.sID_CREDENZIALE]
var s=i.tabResult.getSelectedRows()
if(s&&s.length){var a=s[0]
i.tabResult.getState()[a]=e,i.tabResult.refresh(),setTimeout(function(){i.tabResult.select([a])},100)}else i.btnFind.trigger("click")})}),this.btnCancel=new WUX.WButton(this.subId("bc"),t.TXT.CANCEL,t.ICO.CANCEL,WUX.BTN.ACT_OUTLINE_INFO),this.btnCancel.on("click",function(e){if(i.status!=i.iSTATUS_EDITING)return void i.btnCancel.blur()
WUX.confirm(t.MSG.CONF_CANCEL,function(t){t&&(i.isNew?i.fpDetail.clear():i.onSelect(),i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=null)})}),this.btnDelete=new WUX.WButton(this.subId("bd"),t.TXT.DELETE,t.ICO.DELETE,WUX.BTN.ACT_OUTLINE_DANGER),this.btnDelete.on("click",function(s){if(i.selId=null,i.btnDelete.blur(),i.status==i.iSTATUS_EDITING||i.status==i.iSTATUS_STARTUP)return void WUX.showWarning("Elemento in fase di modifica.")
var a=i.tabResult.getSelectedRowsData()
if(a&&a.length){var n=e.getString(a[0],t.ICredenziale.sID_SERVIZIO),o=e.getString(a[0],t.ICredenziale.sID_CREDENZIALE)
...
return this.tabResult=new WUX.WDXTable(this.subId("tr"),e.col(s,0),e.col(s,1)),this.tabResult.css({h:220}),this.tabResult.widths=[100],this.tabResult.onSelectionChanged(function(t){i.onSelect()}),this.cntActions=new t.AppTableActions("ta"),this.cntActions.left.add(this.btnOpen),this.cntActions.left.add(this.btnDelete),this.cntActions.left.add(this.btnSave),this.cntActions.left.add(this.btnCancel),this.cntActions.right.add(this.btnNew),this.tagsFilter=new WUX.WTags("tf"),this.tcoDetail=new WUX.WTab("tcod"),this.tcoDetail.addTab("Attributi",WUX.WIcon.ADDRESS_CARD).addRow().addCol("12",{h:300}).add(this.fpDetail),this.container=new WUX.WContainer,this.container.attributes=WUX.ATT.STICKY_CONTAINER,this.container.addBox("Filtri di ricerca:","","","boxFilter",WUX.ATT.BOX_FILTER).addTool(this.tagsFilter).addCollapse(this.collapseHandler.bind(this)).addRow().addCol("col-xs-11 b-r").add(this.fpFilter).addCol("col-xs-1 b-l").addGroup({classStyle:"form-group text-right"},this.btnFind,this.btnReset).end().addBox().addGroup({classStyle:"search-actions-and-results-wrapper"},this.cntActions,this.tabResult).end().addRow().addCol("12").section("Dettaglio").add(this.tcoDetail),this.container},s.prototype.collapseHandler=function(t){e.getBoolean(t.data,"collapsed")?this.tagsFilter.setState({}):this.tagsFilter.setState(this.fpFilter.getValues(!0))},s.prototype.onSelect=function(){var i=this,s=e.getItem(this.tabResult.getSelectedRowsData(),0)
if(s){var a=e.getString(s,t.ICredenziale.sID_SERVIZIO),n=e.getString(s,t.ICredenziale.sID_CREDENZIALE)
a&&n&&(this.fpDetail.clear(),this.status==this.iSTATUS_EDITING&&(WUX.showWarning("Modifiche annullate"),this.fpDetail.enabled=!1),jrpc.execute("CREDENZIALI.read",[a,n],function(t){i.fpDetail.setState(t),i.status=i.iSTATUS_VIEW}))}},s}(WUX.WComponent)
t.GUICredenziali=i}(GUI||(GUI={}))
var GUI
!function(t){var e=WUX.WUtil,i=function(e){function i(i){var s=e.call(this,i,"DlgAttCon")||this
return s.title="Configurazione",s.fp=new WUX.WFormPanel(s.subId("fp")),s.fp.addRow(),s.fp.addTextField(t.IAtt.sCONF_OPZIONE,"Opzione"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sCONF_DESCRIZIONE,"Descrizione"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sCONF_VALORI,"Valori"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sCONF_PREDEFINITO,"Predefinito"),s.fp.setMandatory(t.IAtt.sCONF_OPZIONE,t.IAtt.sCONF_DESCRIZIONE),s.body.addRow().addCol("12").add(s.fp),s}return __extends(i,e),i.prototype.updateState=function(t){e.prototype.updateState.call(this,t),this.fp&&(this.fp.clear(),this.fp.setState(this.state))},i.prototype.getState=function(){return this.fp&&(this.state=this.fp.getState()),this.state},i.prototype.onClickOk=function(){var t=this.fp.checkMandatory(!0)
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgAttCon=i
var s=function(e){function i(i){var s=e.call(this,i,"DlgAttPar")||this
return s.title="Parametro",s.fp=new WUX.WFormPanel(s.subId("fp")),s.fp.addRow(),s.fp.addTextField(t.IAtt.sPAR_PARAMETRO,"Parametro"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sPAR_DESCRIZIONE,"Descrizione"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sPAR_VALORI,"Valori"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sPAR_PREDEFINITO,"Predefinito"),s.fp.setMandatory(t.IAtt.sPAR_PARAMETRO,t.IAtt.sPAR_DESCRIZIONE),s.body.addRow().addCol("12").add(s.fp),s}return __extends(i,e),i.prototype.updateState=function(t){e.prototype.updateState.call(this,t),this.fp&&(this.fp.clear(),this.fp.setState(this.state))},i.prototype.getState=function(){return this.fp&&(this.state=this.fp.getState()),this.state},i.prototype.onClickOk=function(){var t=this.fp.checkMandatory(!0)
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgAttPar=s
var a=function(e){function i(i){var s=e.call(this,i,"DlgAttNot")||this
return s.title="Notifica",s.fp=new WUX.WFormPanel(s.subId("fp")),s.fp.addRow(),s.fp.addComponent(t.IAtt.sNOT_EVENTO,"Evento",new t.LJSASelEventi),s.fp.addRow(),s.fp.addTextField(t.IAtt.sNOT_DESTINAZIONE,"Destinazione"),s.fp.setMandatory(t.IAtt.sNOT_EVENTO,t.IAtt.sNOT_DESTINAZIONE),s.body.addRow().addCol("12").add(s.fp),s}return __extends(i,e),i.prototype.updateState=function(t){e.prototype.updateState.call(this,t),this.fp&&(this.fp.clear(),this.fp.setState(this.state))},i.prototype.getState=function(){return this.fp&&(this.state=this.fp.getState()),this.state},i.prototype.onClickOk=function(){var t=this.fp.checkMandatory(!0)
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgAttNot=a
var n=function(e){function i(i){var s=e.call(this,i,"DlgSchedCon")||this
return s.title="Configurazione",s.fp=new WUX.WFormPanel(s.subId("fp")),s.fp.addRow(),s.fp.addTextField(t.ISched.sCONF_OPZIONE,"Opzione"),s.fp.addRow(),s.fp.addTextField(t.ISched.sCONF_DESCRIZIONE,"Descrizione",!0),s.fp.addRow(),s.fp.addTextField(t.ISched.sCONF_VALORI,"Valori",!0),s.fp.addRow(),s.fp.addTextField(t.ISched.sCONF_VALORE,"Valore"),s.fp.setMandatory(t.ISched.sCONF_OPZIONE,t.ISched.sCONF_DESCRIZIONE),s.body.addRow().addCol("12").add(s.fp),s}return __extends(i,e),i.prototype.updateState=function(t){e.prototype.updateState.call(this,t),this.fp&&(this.fp.clear(),this.fp.setState(this.state))},i.prototype.getState=function(){return this.fp&&(this.state=this.fp.getState()),this.state},i.prototype.onClickOk=function(){var t=this.fp.checkMandatory(!0)
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgSchedCon=n
var o=function(e){function i(i){var s=e.call(this,i,"DlgSchedPar")||this
return s.title="Parametro",s.fp=new WUX.WFormPanel(s.subId("fp")),s.fp.addRow(),s.fp.addTextField(t.ISched.sPAR_PARAMETRO,"Parametro"),s.fp.addRow(),s.fp.addTextField(t.ISched.sPAR_DESCRIZIONE,"Descrizione",!0),s.fp.addRow(),s.fp.addTextField(t.ISched.sPAR_VALORI,"Valori",!0),s.fp.addRow(),s.fp.addTextField(t.ISched.sPAR_VALORE,"Valore"),s.fp.setMandatory(t.ISched.sPAR_PARAMETRO,t.ISched.sPAR_DESCRIZIONE),s.body.addRow().addCol("12").add(s.fp),s}return __extends(i,e),i.prototype.updateState=function(t){e.prototype.updateState.call(this,t),this.fp&&(this.fp.clear(),this.fp.setState(this.state))},i.prototype.getState=function(){return this.fp&&(this.state=this.fp.getState()),this.state},i.prototype.onClickOk=function(){var t=this.fp.checkMandatory(!0)
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgSchedPar=o
var l=function(e){function i(i){var s=e.call(this,i,"DlgSchedNot")||this
return s.title="Notifica",s.fp=new WUX.WFormPanel(s.subId("fp")),s.fp.addRow(),s.fp.addComponent(t.ISched.sNOT_EVENTO,"Evento",new t.LJSASelEventi),s.fp.addRow(),s.fp.addTextField(t.ISched.sNOT_DESTINAZIONE,"Destinazione"),s.fp.setMandatory(t.ISched.sNOT_EVENTO,t.ISched.sNOT_DESTINAZIONE),s.body.addRow().addCol("12").add(s.fp),s}return __extends(i,e),i.prototype.updateState=function(t){e.prototype.updateState.call(this,t),this.fp&&(this.fp.clear(),this.fp.setState(this.state))},i.prototype.getState=function(){return this.fp&&(this.state=this.fp.getState()),this.state},i.prototype.onClickOk=function(){var t=this.fp.checkMandatory(!0)
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgSchedNot=l
var d=function(i){function s(s){var a=i.call(this,s,"DlgSchedLog")||this
a.title="Log Schedulazione",a.lblMain=new WUX.WLabel(a.subId("lm")),a.lblMain.css(WUX.CSS.LABEL_INFO)
...
return a.tabData=new WUX.WDXTable(a.subId("tac"),e.col(n,0),e.col(n,1)),a.tabData.types=e.col(n,2),a.tabData.css({h:400}),a.tabData.exportFile="log_schedulazione",a.tabData.onCellPrepared(function(e){e.column.dataField==t.ILog.sID_LOG&&e.cellElement.addClass("clickable")}),a.tabData.onCellClick(function(i){var s=i.row
if(null!=s&&"data"==s.rowType){if(i.column.dataField==t.ILog.sID_LOG){var a=e.getString(i.data,t.ILog.sFILES)
a?WUX.openURL(a,!1,!0):WUX.showWarning("File non disponibili")}}}),a.body.addRow().addCol("12",{a:"right"}).add(a.lblMain).addDiv(8).addRow().addCol("12").add(a.tabData),a}return __extends(s,i),s.prototype.updateProps=function(t){i.prototype.updateProps.call(this,t),this.lblMain&&(this.props?this.lblMain.setState("Id Schedulazione: "+this.props):this.lblMain.setState(""))},s.prototype.updateState=function(t){i.prototype.updateState.call(this,t),this.tabData&&this.tabData.setState(this.state)},s.prototype.getState=function(){return this.tabData&&(this.state=this.tabData.getState()),this.state},s.prototype.onShown=function(){var t=this
this.tabData.scrollTo(0),setTimeout(function(){t.state&&t.state.length?t.tabData.refresh():t.tabData.repaint()},100)},s.prototype.componentDidMount=function(){i.prototype.componentDidMount.call(this),$(window).width()>1260?this.cntMain.css({w:1260,h:600}):this.cntMain.css({w:1e3,h:600})},s}(WUX.WDialog)
t.DlgSchedLog=d}(GUI||(GUI={}))
var GUI
!function(t){var e=WUX.WUtil,i=function(i){function s(s){var a=i.call(this,s||"*","GUISchedulazioni")||this
return a.iSTATUS_STARTUP=0,a.iSTATUS_VIEW=1,a.iSTATUS_EDITING=2,a.status=a.iSTATUS_STARTUP,a.dlgCon=new t.DlgSchedCon(a.subId("dlgsc")),a.dlgCon.onHiddenModal(function(i){if(a.dlgCon.ok){var s=a.tabCon.getState(),n=a.dlgCon.getState(),o=e.indexOf(s,t.ISched.sCONF_OPZIONE,n[t.ISched.sCONF_OPZIONE])
o>=0?s[o]=n:s.push(n),a.tabCon.setState(s)}}),a.dlgPar=new t.DlgSchedPar(a.subId("dlgsp")),a.dlgPar.onHiddenModal(function(i){if(a.dlgPar.ok){var s=a.tabPar.getState(),n=a.dlgPar.getState(),o=e.indexOf(s,t.ISched.sPAR_PARAMETRO,n[t.ISched.sPAR_PARAMETRO])
o>=0?s[o]=n:s.push(n),a.tabPar.setState(s)}}),a.dlgNot=new t.DlgSchedNot(a.subId("dlgsn")),a.dlgNot.onHiddenModal(function(e){if(a.dlgNot.ok){var i=a.tabNot.getState(),s=a.dlgNot.getState(),n=t.indexOf(i,t.ISched.sNOT_EVENTO,t.ISched.sNOT_DESTINAZIONE,s[t.ISched.sCONF_OPZIONE]+":"+s[t.ISched.sNOT_DESTINAZIONE])
n>=0?i[n]=s:i.push(s),a.tabNot.setState(i)}}),a.dlgLog=new t.DlgSchedLog(a.subId("dlgsl")),a}return __extends(s,i),s.prototype.render=function(){var i=this
this.btnFind=new WUX.WButton(this.subId("bf"),t.TXT.FIND,"",WUX.BTN.SM_PRIMARY),this.btnFind.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
var e=i.fpFilter.checkMandatory(!0,!0,!1)
if(e)return void WUX.showWarning("Specificare i seguenti campi: "+e)
var s=WUX.getComponent("boxFilter")
s instanceof WUX.WBox&&(i.tagsFilter.setState(i.fpFilter.getValues(!0)),s.collapse()),i.selId=null,i.find()}),this.btnReset=new WUX.WButton(this.subId("br"),t.TXT.RESET,"",WUX.BTN.SM_SECONDARY),this.btnReset.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
i.fpFilter.clear(),i.tagsFilter.setState({}),i.tabResult.setState([]),i.clearDet(),i.status=i.iSTATUS_STARTUP}),this.fpFilter=new WUX.WFormPanel(this.subId("ff")),this.fpFilter.addRow(),this.fpFilter.addComponent(t.ISched.sID_SERVIZIO,"Servizio",new t.LJSASelServizi),this.fpFilter.addTextField(t.ISched.sID_ATTIVITA,"Attivita'"),this.fpFilter.addComponent(t.ISched.sSTATO,"Stato",new t.LJSASelStati),this.fpFilter.addRow(),this.fpFilter.addTextField(t.ISched.sID_CREDENZIALE_INS,"Cred. Ins."),this.fpFilter.addDateField(t.ISched.sINIZIO_VALIDITA,"Inizio Val."),this.fpFilter.addDateField(t.ISched.sFINE_VALIDITA,"Fine Val."),this.selSerDet=new t.LJSASelServizi,this.selAttDet=new t.LJSASelAttivita,this.selSerDet.on("statechange",function(t){i.selAttDet.service=i.selSerDet.getState()}),this.fpDetail=new WUX.WFormPanel(this.subId("fpd")),this.fpDetail.addRow(),this.fpDetail.addComponent(t.ISched.sID_SERVIZIO,"Servizio",this.selSerDet),this.fpDetail.addComponent(t.ISched.sID_ATTIVITA,"Attivita'",this.selAttDet),this.fpDetail.addRow(),this.fpDetail.addTextField(t.ISched.sDESCRIZIONE,"Descrizione"),this.fpDetail.addTextField(t.ISched.sSCHEDULAZIONE,"Schedulazione"),this.fpDetail.addRow(),this.fpDetail.addDateField(t.ISched.sINIZIO_VALIDITA,"Inizio Val."),this.fpDetail.addDateField(t.ISched.sFINE_VALIDITA,"Fine Val."),this.fpDetail.addInternalField(t.ISched.sID),this.fpDetail.addInternalField(t.ISched.sSTATO),this.fpDetail.addInternalField(t.ISched.sID_CREDENZIALE_INS),this.fpDetail.addInternalField(t.ISched.sDATA_INS),this.fpDetail.addInternalField(t.ISched.sORA_INS),this.fpDetail.addInternalField(t.ISched.sESEC_COMPLETATE),this.fpDetail.addInternalField(t.ISched.sESEC_INTERROTTE),this.fpDetail.enabled=!1,this.fpFilter.onEnterPressed(function(t){i.btnFind.trigger("click")}),this.btnNew=new WUX.WButton(this.subId("bn"),t.TXT.NEW,"",WUX.BTN.SM_INFO),this.btnNew.on("click",function(e){if(i.status==i.iSTATUS_EDITING)return void i.btnNew.blur()
i.isNew=!0,i.status=i.iSTATUS_EDITING,i.selId=null,i.tabResult.clearSelection(),i.enableDet(!0),i.clearDet(),i.selSerDet.setState(t._defService),setTimeout(function(){i.fpDetail.focus()},100)}),this.btnOpen=new WUX.WButton(this.subId("bo"),t.TXT.OPEN,t.ICO.OPEN,WUX.BTN.ACT_OUTLINE_PRIMARY),this.btnOpen.on("click",function(t){if(i.status==i.iSTATUS_EDITING||i.status==i.iSTATUS_STARTUP)return void i.btnOpen.blur()
var e=i.tabResult.getSelectedRows()
if(!e||!e.length)return WUX.showWarning("Seleziona l'elemento da modificare"),void i.btnOpen.blur()
i.isNew=!1,i.status=i.iSTATUS_EDITING,i.selId=null,i.enableDet(!0),setTimeout(function(){i.fpDetail.focus()},100)}),this.btnSave=new WUX.WButton(this.subId("bs"),t.TXT.SAVE,t.ICO.SAVE,WUX.BTN.ACT_OUTLINE_PRIMARY),this.btnSave.on("click",function(e){if(i.status!=i.iSTATUS_EDITING)return WUX.showWarning("Cliccare su Modifica."),void i.btnSave.blur()
var s=i.fpDetail.checkMandatory(!0)
if(s)return i.btnSave.blur(),void WUX.showWarning("Specificare: "+s)
var a=i.fpDetail.getState()
a[t.ISched.sCONFIGURAZIONE]=i.tabCon.getState(),a[t.ISched.sPARAMETRI]=i.tabPar.getState(),a[t.ISched.sNOTIFICA]=i.tabNot.getState(),t.putUserLog(a),i.isNew?jrpc.execute("SCHEDULAZIONI.insert",[a],function(e){i.status=i.iSTATUS_VIEW,i.enableDet(!1),i.selId=e[t.ISched.sID],i.find()}):jrpc.execute("SCHEDULAZIONI.update",[a],function(e){i.status=i.iSTATUS_VIEW,i.enableDet(!1),i.selId=e[t.ISched.sID]
var s=i.tabResult.getSelectedRows()
if(s&&s.length){var a=s[0]
i.tabResult.getState()[a]=e,i.tabResult.refresh(),setTimeout(function(){i.tabResult.select([a])},100)}else i.find()})}),this.btnCancel=new WUX.WButton(this.subId("bc"),t.TXT.CANCEL,t.ICO.CANCEL,WUX.BTN.ACT_OUTLINE_INFO),this.btnCancel.on("click",function(e){if(i.status!=i.iSTATUS_EDITING)return void i.btnCancel.blur()
WUX.confirm(t.MSG.CONF_CANCEL,function(t){t&&(i.isNew?i.clearDet():i.onSelect(),i.status=i.iSTATUS_VIEW,i.enableDet(!1),i.selId=null)})}),this.btnDelete=new WUX.WButton(this.subId("bd"),t.TXT.DELETE,t.ICO.DELETE,WUX.BTN.ACT_OUTLINE_DANGER),this.btnDelete.on("click",function(s){if(i.selId=null,i.btnDelete.blur(),i.status==i.iSTATUS_EDITING||i.status==i.iSTATUS_STARTUP)return void WUX.showWarning("Elemento in fase di modifica.")
var a=i.tabResult.getSelectedRowsData()
if(a&&a.length){var n=e.getString(a[0],t.ISched.sID_SERVIZIO),o=e.getNumber(a[0],t.ISched.sID),l=t.getUserLogged().userName
WUX.confirm(t.MSG.CONF_DELETE,function(t){t&&jrpc.execute("SCHEDULAZIONI.delete",[n,o,l],function(t){i.find()})})}}),this.btnToggle=new WUX.WButton(this.subId("bt"),"Abilita",WUX.WIcon.THUMBS_O_UP,WUX.BTN.ACT_OUTLINE_DANGER),this.btnToggle.on("click",function(s){i.btnToggle.blur()
var a=i.tabResult.getSelectedRowsData()
if(!a||!a.length)return void WUX.showWarning("Selezione l'elemento da abilitare/disabilitare")
var n=e.getString(a[0],t.ISched.sID_SERVIZIO),o=e.getNumber(a[0],t.ISched.sID),l=e.getString(a[0],t.ISched.sSTATO),d="D"==l,r=t.getUserLogged().userName
i.selId=o,jrpc.execute("SCHEDULAZIONI.setEnabled",[n,o,d,r],function(e){var s=i.tabResult.getSelectedRows()
if(s&&s.length){var a=i.tabResult.getState(),n=s[0]
d?(a[n][t.ISched.sSTATO]="A",i.btnToggle.setText("Disabilita",WUX.WIcon.THUMBS_O_DOWN),i.btnToggle.setText("Disabilita",WUX.WIcon.THUMBS_O_DOWN)):(a[n][t.ISched.sSTATO]="D",i.btnToggle.setText("Abilita",WUX.WIcon.THUMBS_O_UP),i.btnToggle.setText("Abilita",WUX.WIcon.THUMBS_O_UP)),i.tabResult.refresh(),setTimeout(function(){i.tabResult.select([n])},100)}else i.find()})}),this.btnLog=new WUX.WButton(this.subId("bl"),t.TXT.VIEW,t.ICO.VIEW,WUX.BTN.ACT_OUTLINE_INFO),this.btnLog.on("click",function(s){i.btnLog.blur()
var a=i.tabResult.getSelectedRowsData()
if(!a||!a.length)return void WUX.showWarning("Selezione una schedulazione")
var n=e.getNumber(a[0],t.ISched.sID)
...
var s=[["Id",t.ISched.sID],["Servizio",t.ISched.sID_SERVIZIO],["Attivita'",t.ISched.sID_ATTIVITA],["Schedulazione",t.ISched.sSCHEDULAZIONE],["Stato",t.ISched.sSTATO],["Descrizione",t.ISched.sDESCRIZIONE],["Esec. Compl.",t.ISched.sESEC_COMPLETATE],["Esec. Int.",t.ISched.sESEC_INTERROTTE],["Id Cred. Ins.",t.ISched.sID_CREDENZIALE_INS],["Data Ins.",t.ISched.sDATA_INS],["Ora Ins.",t.ISched.sORA_INS],["Id Cred. Agg.",t.ISched.sID_CREDENZIALE_AGG],["Data Agg.",t.ISched.sDATA_AGG],["Ora Agg.",t.ISched.sORA_AGG]]
...
break
case 3:i.tabNot.repaint()}}),this.container=new WUX.WContainer,this.container.attributes=WUX.ATT.STICKY_CONTAINER,this.container.addBox("Filtri di ricerca:","","","boxFilter",WUX.ATT.BOX_FILTER).addTool(this.tagsFilter).addCollapse(this.collapseHandler.bind(this)).addRow().addCol("col-xs-11 b-r").add(this.fpFilter).addCol("col-xs-1 b-l").addGroup({classStyle:"form-group text-right"},this.btnFind,this.btnReset).end().addBox().addGroup({classStyle:"search-actions-and-results-wrapper"},this.cntActions,this.tabResult).end().addRow().addCol("12").section("Dettaglio").add(this.tcoDetail),this.container},s.prototype.collapseHandler=function(t){e.getBoolean(t.data,"collapsed")?this.tagsFilter.setState({}):this.tagsFilter.setState(this.fpFilter.getValues(!0))},s.prototype.onSelect=function(){var i=this,s=e.getItem(this.tabResult.getSelectedRowsData(),0)
if(s){var a=e.getNumber(s,t.ISched.sID)
a&&(this.clearDet(),this.status==this.iSTATUS_EDITING&&(WUX.showWarning("Modifiche annullate"),this.enableDet(!1)),jrpc.execute("SCHEDULAZIONI.read",[a],function(s){s[t.ISched.sID_SERVIZIO]=t.getIdVal(s,t.ISched.sID_SERVIZIO),s[t.ISched.sID_ATTIVITA]=t.getIdVal(s,t.ISched.sID_ATTIVITA),i.fpDetail.setState(s),i.tabCon.setState(e.getArray(s,t.ISched.sCONFIGURAZIONE)),i.tabPar.setState(e.getArray(s,t.ISched.sPARAMETRI)),i.tabNot.setState(e.getArray(s,t.ISched.sNOTIFICA)),"D"==e.getString(s,t.ISched.sSTATO)?(i.btnToggle.setText("Abilita",WUX.WIcon.THUMBS_O_UP),i.btnToggle.setText("Abilita",WUX.WIcon.THUMBS_O_UP)):(i.btnToggle.setText("Disabilita",WUX.WIcon.THUMBS_O_DOWN),i.btnToggle.setText("Disabilita",WUX.WIcon.THUMBS_O_DOWN)),i.status=i.iSTATUS_VIEW}))}},s.prototype.clearDet=function(){this.fpDetail.clear(),this.tabCon.setState([]),this.tabPar.setState([]),this.tabNot.setState([])},s.prototype.enableDet=function(t){this.fpDetail.enabled=t,this.tabCon.enabled=t,this.tabPar.enabled=t,this.tabNot.enabled=t},s.prototype.find=function(){var i=this,s=t.getUserLogged()
jrpc.execute("SCHEDULAZIONI.find",[this.fpFilter.getState(),s.groups],function(s){if(i.tabResult.setState(s),i.clearDet(),i.status=i.iSTATUS_STARTUP,i.selId){var a=e.indexOf(s,t.ISched.sID,i.selId)
a>=0&&setTimeout(function(){i.tabResult.select([a])},100),i.selId=null}})},s}(WUX.WComponent)
...
jrpc.execute("SERVIZI.find",[i.fpFilter.getState(),o.groups],function(s){if(i.tabResult.setState(s),i.fpDetail.clear(),i.status=i.iSTATUS_STARTUP,i.selId){var a=e.indexOf(s,t.IServizio.sID_SERVIZIO,i.selId)
a>=0&&setTimeout(function(){i.tabResult.select([a])},100),i.selId=null}})}),this.btnReset=new WUX.WButton(this.subId("br"),t.TXT.RESET,"",WUX.BTN.SM_SECONDARY),this.btnReset.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
...
if(s)return i.btnSave.blur(),void WUX.showWarning("Specificare: "+s)
var a=i.fpDetail.getState()
i.isNew?jrpc.execute("SERVIZI.insert",[a],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.IServizio.sID_SERVIZIO],i.btnFind.trigger("click")}):jrpc.execute("SERVIZI.update",[a],function(e){i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=e[t.IServizio.sID_SERVIZIO]
var s=i.tabResult.getSelectedRows()
if(s&&s.length){var a=s[0]
i.tabResult.getState()[a]=e,i.tabResult.refresh(),setTimeout(function(){i.tabResult.select([a])},100)}else i.btnFind.trigger("click")})}),this.btnCancel=new WUX.WButton(this.subId("bc"),t.TXT.CANCEL,t.ICO.CANCEL,WUX.BTN.ACT_OUTLINE_INFO),this.btnCancel.on("click",function(e){if(i.status!=i.iSTATUS_EDITING)return void i.btnCancel.blur()
WUX.confirm(t.MSG.CONF_CANCEL,function(t){t&&(i.isNew?i.fpDetail.clear():i.onSelect(),i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=null)})}),this.btnDelete=new WUX.WButton(this.subId("bd"),t.TXT.DELETE,t.ICO.DELETE,WUX.BTN.ACT_OUTLINE_DANGER),this.btnDelete.on("click",function(s){if(i.selId=null,i.btnDelete.blur(),i.status==i.iSTATUS_EDITING||i.status==i.iSTATUS_STARTUP)return void WUX.showWarning("Elemento in fase di modifica.")
var a=i.tabResult.getSelectedRowsData()
if(a&&a.length){var n=e.getString(a[0],t.IServizio.sID_SERVIZIO)
...
return this.tabResult=new WUX.WDXTable(this.subId("tr"),e.col(s,0),e.col(s,1)),this.tabResult.css({h:220}),this.tabResult.widths=[100],this.tabResult.onSelectionChanged(function(t){i.onSelect()}),this.cntActions=new t.AppTableActions("ta"),this.cntActions.left.add(this.btnOpen),this.cntActions.left.add(this.btnDelete),this.cntActions.left.add(this.btnSave),this.cntActions.left.add(this.btnCancel),this.cntActions.right.add(this.btnNew),this.tagsFilter=new WUX.WTags("tf"),this.tcoDetail=new WUX.WTab("tcod"),this.tcoDetail.addTab("Attributi",WUX.WIcon.ADDRESS_CARD).addRow().addCol("12",{h:300}).add(this.fpDetail),this.container=new WUX.WContainer,this.container.attributes=WUX.ATT.STICKY_CONTAINER,this.container.addBox("Filtri di ricerca:","","","boxFilter",WUX.ATT.BOX_FILTER).addTool(this.tagsFilter).addCollapse(this.collapseHandler.bind(this)).addRow().addCol("col-xs-11 b-r").add(this.fpFilter).addCol("col-xs-1 b-l").addGroup({classStyle:"form-group text-right"},this.btnFind,this.btnReset).end().addBox().addGroup({classStyle:"search-actions-and-results-wrapper"},this.cntActions,this.tabResult).end().addRow().addCol("12").section("Dettaglio").add(this.tcoDetail),this.container},s.prototype.collapseHandler=function(t){e.getBoolean(t.data,"collapsed")?this.tagsFilter.setState({}):this.tagsFilter.setState(this.fpFilter.getValues(!0))},s.prototype.onSelect=function(){var i=this,s=e.getItem(this.tabResult.getSelectedRowsData(),0)
if(s){var a=e.getString(s,t.IServizio.sID_SERVIZIO)
a&&(this.fpDetail.clear(),this.status==this.iSTATUS_EDITING&&(WUX.showWarning("Modifiche annullate"),this.fpDetail.enabled=!1),jrpc.execute("SERVIZI.read",[a],function(t){i.fpDetail.setState(t),i.status=i.iSTATUS_VIEW}))}},s}(WUX.WComponent)
