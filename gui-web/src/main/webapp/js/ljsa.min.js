var GUI
!function(t){var e=WUX.WUtil,i=function(i){function s(t){var e=i.call(this,t||"*","GUIAttivita")||this
...
return s.title="Configurazione",s.fp=new WUX.WFormPanel(s.subId("fp")),s.fp.addRow(),s.fp.addTextField(t.IAtt.sCONF_OPZIONE,"Opzione"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sCONF_DESCRIZIONE,"Descrizione"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sCONF_VALORI,"Valori"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sCONF_PREDEFINITO,"Predefinito"),s.fp.setMandatory(t.IAtt.sCONF_OPZIONE,t.IAtt.sCONF_DESCRIZIONE),s.body.addRow().addCol("12").add(s.fp),s}return __extends(i,e),i.prototype.getState=function(){return this.fp&&(this.state=this.fp.getState()),this.state},i.prototype.onShown=function(){this.fp.clear()},i.prototype.onClickOk=function(){var t=this.fp.checkMandatory(!0)
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgAttCon=e
var i=function(e){function i(i){var s=e.call(this,i,"DlgAttPar")||this
return s.title="Parametro",s.fp=new WUX.WFormPanel(s.subId("fp")),s.fp.addRow(),s.fp.addTextField(t.IAtt.sPAR_PARAMETRO,"Parametro"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sPAR_DESCRIZIONE,"Descrizione"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sPAR_VALORI,"Valori"),s.fp.addRow(),s.fp.addTextField(t.IAtt.sPAR_PREDEFINITO,"Predefinito"),s.fp.setMandatory(t.IAtt.sPAR_PARAMETRO,t.IAtt.sPAR_DESCRIZIONE),s.body.addRow().addCol("12").add(s.fp),s}return __extends(i,e),i.prototype.getState=function(){return this.fp&&(this.state=this.fp.getState()),this.state},i.prototype.onShown=function(){this.fp.clear()},i.prototype.onClickOk=function(){var t=this.fp.checkMandatory(!0)
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgAttPar=i}(GUI||(GUI={}))
var GUI
