...
return n.iSTATUS_STARTUP=0,n.iSTATUS_VIEW=1,n.iSTATUS_EDITING=2,n.status=n.iSTATUS_STARTUP,n.dlgCon=new t.DlgAttCon(n.subId("dlgac")),n.dlgCon.onHiddenModal(function(i){if(n.dlgCon.ok){var s=n.tabCon.getState(),a=n.dlgCon.getState(),o=e.indexOf(s,t.IAtt.sCONF_OPZIONE,a[t.IAtt.sCONF_OPZIONE])
o>=0?s[o]=a:s.push(a),n.tabCon.setState(s)}}),n.dlgPar=new t.DlgAttPar(n.subId("dlgap")),n.dlgPar.onHiddenModal(function(i){if(n.dlgPar.ok){var s=n.tabPar.getState(),a=n.dlgPar.getState(),o=e.indexOf(s,t.IAtt.sPAR_PARAMETRO,a[t.IAtt.sPAR_PARAMETRO])
o>=0?s[o]=a:s.push(a),n.tabPar.setState(s)}}),n.dlgNot=new t.DlgAttNot(n.subId("dlgan")),n.dlgNot.onHiddenModal(function(e){if(n.dlgNot.ok){var i=n.tabNot.getState(),s=n.dlgNot.getState(),a=t.indexOf(i,t.IAtt.sNOT_EVENTO,t.IAtt.sNOT_DESTINAZIONE,s[t.IAtt.sCONF_OPZIONE]+":"+s[t.IAtt.sNOT_DESTINAZIONE])
a>=0?i[a]=s:i.push(s),n.tabNot.setState(i)}}),n}return __extends(s,i),s.prototype.render=function(){var i=this
...
n[t.IAtt.sCONFIGURAZIONE]=i.tabCon.getState(),n[t.IAtt.sPARAMETRI]=i.tabPar.getState(),n[t.IAtt.sNOTIFICA]=i.tabNot.getState(),t.putUserLog(n),i.isNew?jrpc.execute("ATTIVITA.insert",[n],function(e){i.status=i.iSTATUS_VIEW,i.enableDet(!1),i.selId=e[t.IAtt.sID_SERVIZIO]+":"+e[t.IAtt.sID_ATTIVITA],i.btnFind.trigger("click")}):jrpc.execute("ATTIVITA.update",[n],function(e){i.status=i.iSTATUS_VIEW,i.enableDet(!1),i.selId=e[t.IAtt.sID_SERVIZIO]+":"+e[t.IAtt.sID_ATTIVITA]
...
if(n&&n.length){var a=e.getString(n[0],t.IAtt.sID_SERVIZIO),o=e.getString(n[0],t.IAtt.sID_ATTIVITA)
WUX.confirm(t.MSG.CONF_DELETE,function(t){t&&jrpc.execute("ATTIVITA.delete",[a,o],function(t){i.btnFind.trigger("click")})})}})
...
for(var n=d.toArray(t),a=0;a<n.length;a++){if(d.getValue(n[a],e)+":"+d.getValue(n[a],i)==s)return a}return-1}function o(t){return t?(t[r.sUSER_LOG]=e().userName,t):t}function l(t,e){if(!t||!e)return t
var i=t[e]
return Array.isArray(i)?i.length>1?i[0]:null:i}var d=WUX.WUtil
t.LJSA_SERVICE="LJSA",t._defService="",t.getUserLogged=e,t.getConfig=i,t.getLocale=s,t.isDevMode=n,t.indexOf=a,t.putUserLog=o,t.getIdVal=l
...
jrpc.execute("SERVIZI.lookup",[i.groups],function(t){for(var i=[],s=0;s<t.length;s++){var n=t[s],a={id:n[0],text:n[0]}
i.push(a)}var o={data:i,placeholder:"",allowClear:!0}
...
t.LJSASelClassi=n
var a=function(i){function s(t,e){var s=i.call(this,t)||this
...
var n=e.toString(s)
n&&(t._defService=n)},s.prototype.componentDidMount=function(){var e=this
jrpc.execute("ATTIVITA.lookup",[t._defService,""],function(i){e._serviceL=t._defService
for(var s=[],n=0;n<i.length;n++){var a=i[n],o={id:a[0],text:a[0]}
...
WUX.confirm(t.MSG.CONF_CANCEL,function(t){t&&(i.isNew?i.fpDetail.clear():i.onSelect(),i.status=i.iSTATUS_VIEW,i.fpDetail.enabled=!1,i.selId=null)})}),this.btnDelete=new WUX.WButton(this.subId("bd"),t.TXT.DELETE,t.ICO.DELETE,WUX.BTN.ACT_OUTLINE_DANGER),this.btnDelete.on("click",function(s){if(i.selId=null,i.btnDelete.blur(),i.status==i.iSTATUS_EDITING||i.status==i.iSTATUS_STARTUP)return void WUX.showWarning("Elemento in fase di modifica.")
var n=i.tabResult.getSelectedRowsData()
if(n&&n.length){var a=e.getString(n[0],t.ICredenziale.sID_SERVIZIO),o=e.getString(n[0],t.ICredenziale.sID_CREDENZIALE)
WUX.confirm(t.MSG.CONF_DELETE,function(t){t&&jrpc.execute("CREDENZIALI.delete",[a,o],function(t){i.btnFind.trigger("click")})})}})
...
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgSchedCon=n
var a=function(e){function i(i){var s=e.call(this,i,"DlgSchedPar")||this
...
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgSchedPar=a
var o=function(e){function i(i){var s=e.call(this,i,"DlgSchedNot")||this
...
return!t||(WUX.showWarning("Specificare: "+t),!1)},i}(WUX.WDialog)
t.DlgSchedNot=o}(GUI||(GUI={}))
var GUI
!function(t){var e=WUX.WUtil,i=function(i){function s(s){var n=i.call(this,s||"*","GUISchedulazioni")||this
return n.iSTATUS_STARTUP=0,n.iSTATUS_VIEW=1,n.iSTATUS_EDITING=2,n.status=n.iSTATUS_STARTUP,n.dlgCon=new t.DlgSchedCon(n.subId("dlgac")),n.dlgCon.onHiddenModal(function(i){if(n.dlgCon.ok){var s=n.tabCon.getState(),a=n.dlgCon.getState(),o=e.indexOf(s,t.ISched.sCONF_OPZIONE,a[t.ISched.sCONF_OPZIONE])
o>=0?s[o]=a:s.push(a),n.tabCon.setState(s)}}),n.dlgPar=new t.DlgSchedPar(n.subId("dlgap")),n.dlgPar.onHiddenModal(function(i){if(n.dlgPar.ok){var s=n.tabPar.getState(),a=n.dlgPar.getState(),o=e.indexOf(s,t.ISched.sPAR_PARAMETRO,a[t.ISched.sPAR_PARAMETRO])
o>=0?s[o]=a:s.push(a),n.tabPar.setState(s)}}),n.dlgNot=new t.DlgSchedNot(n.subId("dlgan")),n.dlgNot.onHiddenModal(function(e){if(n.dlgNot.ok){var i=n.tabNot.getState(),s=n.dlgNot.getState(),a=t.indexOf(i,t.ISched.sNOT_EVENTO,t.ISched.sNOT_DESTINAZIONE,s[t.ISched.sCONF_OPZIONE]+":"+s[t.ISched.sNOT_DESTINAZIONE])
a>=0?i[a]=s:i.push(s),n.tabNot.setState(i)}}),n}return __extends(s,i),s.prototype.render=function(){var i=this
this.btnFind=new WUX.WButton(this.subId("bf"),t.TXT.FIND,"",WUX.BTN.SM_PRIMARY),this.btnFind.on("click",function(s){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
var n=i.fpFilter.checkMandatory(!0,!0,!1)
if(n)return void WUX.showWarning("Specificare i seguenti campi: "+n)
...
jrpc.execute("SCHEDULAZIONI.find",[i.fpFilter.getState(),o.groups],function(s){if(i.tabResult.setState(s),i.clearDet(),i.status=i.iSTATUS_STARTUP,i.selId){var n=e.indexOf(s,t.ISched.sID,i.selId)
n>=0&&setTimeout(function(){i.tabResult.select([n])},100),i.selId=null}})}),this.btnReset=new WUX.WButton(this.subId("br"),t.TXT.RESET,"",WUX.BTN.SM_SECONDARY),this.btnReset.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
...
if(s)return i.btnSave.blur(),void WUX.showWarning("Specificare: "+s)
var n=i.fpDetail.getState()
n[t.ISched.sCONFIGURAZIONE]=i.tabCon.getState(),n[t.ISched.sPARAMETRI]=i.tabPar.getState(),n[t.ISched.sNOTIFICA]=i.tabNot.getState(),t.putUserLog(n),i.isNew?jrpc.execute("SCHEDULAZIONI.insert",[n],function(e){i.status=i.iSTATUS_VIEW,i.enableDet(!1),i.selId=e[t.ISched.sID],i.btnFind.trigger("click")}):jrpc.execute("SCHEDULAZIONI.update",[n],function(e){i.status=i.iSTATUS_VIEW,i.enableDet(!1),i.selId=e[t.ISched.sID]
var s=i.tabResult.getSelectedRows()
if(s&&s.length){var n=s[0]
i.tabResult.getState()[n]=e,i.tabResult.refresh(),setTimeout(function(){i.tabResult.select([n])},100)}else i.btnFind.trigger("click")})}),this.btnCancel=new WUX.WButton(this.subId("bc"),t.TXT.CANCEL,t.ICO.CANCEL,WUX.BTN.ACT_OUTLINE_INFO),this.btnCancel.on("click",function(e){if(i.status!=i.iSTATUS_EDITING)return void i.btnCancel.blur()
WUX.confirm(t.MSG.CONF_CANCEL,function(t){t&&(i.isNew?i.clearDet():i.onSelect(),i.status=i.iSTATUS_VIEW,i.enableDet(!1),i.selId=null)})}),this.btnDelete=new WUX.WButton(this.subId("bd"),t.TXT.DELETE,t.ICO.DELETE,WUX.BTN.ACT_OUTLINE_DANGER),this.btnDelete.on("click",function(s){if(i.selId=null,i.btnDelete.blur(),i.status==i.iSTATUS_EDITING||i.status==i.iSTATUS_STARTUP)return void WUX.showWarning("Elemento in fase di modifica.")
var n=i.tabResult.getSelectedRowsData()
if(n&&n.length){var a=e.getString(n[0],t.ISched.sID_SERVIZIO),o=e.getNumber(n[0],t.ISched.sID),l=t.getUserLogged().userName
WUX.confirm(t.MSG.CONF_DELETE,function(t){t&&jrpc.execute("SCHEDULAZIONI.delete",[a,o,l],function(t){i.btnFind.trigger("click")})})}}),this.btnToggle=new WUX.WButton(this.subId("bt"),"Abilita",WUX.WIcon.THUMBS_O_UP,WUX.BTN.ACT_OUTLINE_DANGER),this.btnToggle.on("click",function(s){i.btnToggle.blur()
var n=i.tabResult.getSelectedRowsData()
if(!n||!n.length)return void WUX.showWarning("Selezione l'elemento da abilitare/disabilitare")
var a=e.getString(n[0],t.ISched.sID_SERVIZIO),o=e.getNumber(n[0],t.ISched.sID),l=e.getString(n[0],t.ISched.sSTATO),d=!("D"==l),r=t.getUserLogged().userName
i.selId=o,jrpc.execute("SCHEDULAZIONI.setEnabled",[a,o,d,r],function(e){var s=i.tabResult.getSelectedRows()
if(s&&s.length){var n=i.tabResult.getState(),a=s[0]
d?(n[a][t.ISched.sSTATO]="A",i.btnToggle.setText("Disabilita",WUX.WIcon.THUMBS_O_DOWN),i.btnToggle.setText("Disabilita",WUX.WIcon.THUMBS_O_DOWN)):(n[a][t.ISched.sSTATO]="D",i.btnToggle.setText("Abilita",WUX.WIcon.THUMBS_O_UP),i.btnToggle.setText("Abilita",WUX.WIcon.THUMBS_O_UP)),i.tabResult.refresh(),setTimeout(function(){i.tabResult.select([a])},100)}else i.btnFind.trigger("click")})})
...
e&&e.length&&(i.dlgNot.setState(e[0]),i.dlgNot.show(i))}),this.btnAddNot=new WUX.WButton(this.subId("ban"),t.TXT.ADD,"",WUX.BTN.SM_PRIMARY),this.btnAddNot.on("click",function(t){i.dlgNot.setState(null),i.dlgNot.show(i)}),this.btnRemNot=new WUX.WButton(this.subId("brn"),t.TXT.REMOVE,"",WUX.BTN.SM_DANGER),this.btnRemNot.on("click",function(t){var e=i.tabNot.getSelectedRows()
if(e&&e.length){var s=i.tabNot.getState()
s.splice(e[0],1),i.tabNot.setState(s)}}),this.cntActions=new t.AppTableActions("ta"),this.cntActions.left.add(this.btnOpen),this.cntActions.left.add(this.btnDelete),this.cntActions.left.add(this.btnSave),this.cntActions.left.add(this.btnCancel),this.cntActions.left.add(this.btnToggle),this.cntActions.right.add(this.btnNew),this.tagsFilter=new WUX.WTags("tf"),this.tcoDetail=new WUX.WTab("tcod"),this.tcoDetail.addTab("Attributi",WUX.WIcon.ADDRESS_CARD).addRow().addCol("12",{h:300}).add(this.fpDetail),this.tcoDetail.addTab("Configurazione",WUX.WIcon.WRENCH).addRow().addCol("11",{h:300}).add(this.tabCon).addCol("1",{h:300}).addStack(WUX.CSS.STACK_BTNS,this.btnAddCon,this.btnRemCon),this.tcoDetail.addTab("Parametri",WUX.WIcon.EDIT).addRow().addCol("11",{h:300}).add(this.tabPar).addCol("1",{h:300}).addStack(WUX.CSS.STACK_BTNS,this.btnAddPar,this.btnRemPar),this.tcoDetail.addTab("Notifica",WUX.WIcon.ENVELOPE_O).addRow().addCol("11",{h:300}).add(this.tabNot).addCol("1",{h:300}).addStack(WUX.CSS.STACK_BTNS,this.btnAddNot,this.btnRemNot),this.tcoDetail.on("statechange",function(t){switch(i.tcoDetail.getState()){case 0:break
case 1:i.tabCon.repaint()
break
case 2:i.tabPar.repaint()
break
case 3:i.tabNot.repaint()}}),this.container=new WUX.WContainer,this.container.attributes=WUX.ATT.STICKY_CONTAINER,this.container.addBox("Filtri di ricerca:","","","boxFilter",WUX.ATT.BOX_FILTER).addTool(this.tagsFilter).addCollapse(this.collapseHandler.bind(this)).addRow().addCol("col-xs-11 b-r").add(this.fpFilter).addCol("col-xs-1 b-l").addGroup({classStyle:"form-group text-right"},this.btnFind,this.btnReset).end().addBox().addGroup({classStyle:"search-actions-and-results-wrapper"},this.cntActions,this.tabResult).end().addRow().addCol("12").section("Dettaglio").add(this.tcoDetail),this.container},s.prototype.collapseHandler=function(t){e.getBoolean(t.data,"collapsed")?this.tagsFilter.setState({}):this.tagsFilter.setState(this.fpFilter.getValues(!0))},s.prototype.onSelect=function(){var i=this,s=e.getItem(this.tabResult.getSelectedRowsData(),0)
if(s){var n=e.getNumber(s,t.ISched.sID)
n&&(this.clearDet(),this.status==this.iSTATUS_EDITING&&(WUX.showWarning("Modifiche annullate"),this.enableDet(!1)),jrpc.execute("SCHEDULAZIONI.read",[n],function(s){s[t.ISched.sID_SERVIZIO]=t.getIdVal(s,t.ISched.sID_SERVIZIO),s[t.ISched.sID_ATTIVITA]=t.getIdVal(s,t.ISched.sID_ATTIVITA),i.fpDetail.setState(s),i.tabCon.setState(e.getArray(s,t.ISched.sCONFIGURAZIONE)),i.tabPar.setState(e.getArray(s,t.ISched.sPARAMETRI)),i.tabNot.setState(e.getArray(s,t.ISched.sNOTIFICA)),"D"==e.getString(s,t.ISched.sSTATO)?(i.btnToggle.setText("Abilita",WUX.WIcon.THUMBS_O_UP),i.btnToggle.setText("Abilita",WUX.WIcon.THUMBS_O_UP)):(i.btnToggle.setText("Disabilita",WUX.WIcon.THUMBS_O_DOWN),i.btnToggle.setText("Disabilita",WUX.WIcon.THUMBS_O_DOWN)),i.status=i.iSTATUS_VIEW}))}},s.prototype.clearDet=function(){this.fpDetail.clear(),this.tabCon.setState([]),this.tabPar.setState([]),this.tabNot.setState([])},s.prototype.enableDet=function(t){this.fpDetail.enabled=t,this.tabCon.enabled=t,this.tabPar.enabled=t,this.tabNot.enabled=t},s}(WUX.WComponent)
...
a instanceof WUX.WBox&&(i.tagsFilter.setState(i.fpFilter.getValues(!0)),a.collapse())
var o=t.getUserLogged()
jrpc.execute("SERVIZI.find",[i.fpFilter.getState(),o.groups],function(s){if(i.tabResult.setState(s),i.fpDetail.clear(),i.status=i.iSTATUS_STARTUP,i.selId){var n=e.indexOf(s,t.IServizio.sID_SERVIZIO,i.selId)
n>=0&&setTimeout(function(){i.tabResult.select([n])},100),i.selId=null}})}),this.btnReset=new WUX.WButton(this.subId("br"),t.TXT.RESET,"",WUX.BTN.SM_SECONDARY),this.btnReset.on("click",function(t){if(i.status==i.iSTATUS_EDITING)return void WUX.showWarning("Elemento in fase di modifica.")
