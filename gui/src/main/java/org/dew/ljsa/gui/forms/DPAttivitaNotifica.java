...
import org.dew.ljsa.gui.dialogs.DlgAttivitaNotifica;
...
public
class DPAttivitaNotifica extends ADataPanel implements IAttivita, ActionListener, ListSelectionListener
{
  private static final long serialVersionUID = -2140421922865215607L;
  ...
  protected
  boolean exist(String sEvento, String sDestinazione)
  {
