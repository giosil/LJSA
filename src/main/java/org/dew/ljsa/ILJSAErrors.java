...
interface ILJSAErrors
{
  ...
  public static final String sINVALID_CLASS          = "LJSA-003#Classe attivita' non valida: ";
  public static final String sSLEEPING_MODE          = "LJSA-004#LJSA e' in sleeping mode.";
  ...
  public static final String sACTIVITY_UNREMOVABLE   = "LJSA-010#L'attivita' non puo' essere rimossa.";
  public static final String sDB_NOT_AVAILABLE       = "LJSA-011#Database non disponibile.";
  public static final String sSCHED_EXPIRED          = "LJSA-012#Schedulazione scaduta (verificare la fine validita').";
  ...
  public static final String sALREADY_RUNNING        = "LJSA-016#L'istanza di LJSA e' gia' in running.";
}
